                    ...
                    <div class="row">
                        ...
                        <div class="d-flex no-login mt-3 bg-light justify-content-center w-100  align-items-center">
                            <div class="p-2 bd-highlight">
                                ...
                                Bạn cần gia hạn khóa học này
                                </h4>
                                <div class="mt-3 text-center">
                                   <a class="btn btn-danger mx-auto" href="/gia-han/{{$course['id']}}-{{$course['slug']}}"><i class="fa fa-cart-plus" aria-hidden="true"></i> Gia hạn khóa học này</a>
                                </div>
